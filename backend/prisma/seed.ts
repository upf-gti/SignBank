import { PrismaClient, Role, Language, LexicalCategory, GlossStatus, RelationType } from '@prisma/client';
import * as argon2 from 'argon2';
import { seedCompoundBessonsExample } from './seed/compound-bessons-1d';
import { ensurePhonologyCatalog } from '../src/phonology-values/phonology-catalog.seed';
import { videoDataFromCodes } from '../src/phonology-values/phonology-video-data';

const prisma = new PrismaClient();

async function main() {
  await ensurePhonologyCatalog(prisma);
    ...
    collSenseTitles.map((senseTitle) =>
      prisma.signVideo.create({
        data: {
          ...
          videoData: {
            create: videoDataFromCodes({
              handedness: senseTitle === 'Coll (part del cos)' ? 'ONE' : 'TWO_S',
              dominantConfiguration: 'CONF_1',
              configurationChanges: 'BENDING',
              dominantRelationBetweenArticulators: 'ABOVE',
              location: senseTitle === 'Coll (part del cos)' ? 'NECK' : 'NEUTRAL_SPACE',
  ...
  await prisma.signVideo.create({
    data: {
      ...
      videoData: {
        create: videoDataFromCodes({
          handedness: 'TWO_S',
          dominantConfiguration: 'CONF_8',
          configurationChanges: 'OPENING_AND_SPREADING',
          dominantRelationBetweenArticulators: 'CROSS',
          location: 'CHEST',
          movementRelatedOrientation: 'FRONT',
          orientationRelatedToLocation: 'AO_FINGERS_CONTRA',
  ...
  await prisma.signVideo.create({
    data: {
      ...
      videoData: {
        create: videoDataFromCodes({
          handedness: 'ONE',
          dominantConfiguration: 'CONF_15',
          configurationChanges: 'CLOSING_AND_WIGGLING',
          dominantRelationBetweenArticulators: 'FRONT',
          location: 'CHEEK',
          movementRelatedOrientation: 'FRONT',
          orientationRelatedToLocation: 'AO_FINGERS_CONTRA',
          orientationChange: 'EXTENSION_AND_PRONATION',
          contactType: 'DOUBLE',
          movementType: 'CIRCLE',
          movementDirection: 'BACKWARDS',
          vocalization: 'none',
    ...
    prisma.signVideo.create({
      data: {
        ...
        videoData: {
          create: videoDataFromCodes({
            handedness: 'TWO_S',
            dominantConfiguration: 'CONF_23',
            configurationChanges: 'CLOSING_AND_RUBBING',
            dominantRelationBetweenArticulators: 'INSIDE',
            location: 'NEUTRAL_SPACE',
            movementRelatedOrientation: 'FRONT',
            orientationRelatedToLocation: 'AO_FINGERS_CONTRA',
            orientationChange: 'PRONATION',
            contactType: 'CONTINUOUS_TO_FINAL',
            movementType: 'MOTIVATED_SHAPE',
            movementDirection: 'BACKWARDS',
            vocalization: 'none',
    ...
    prisma.signVideo.create({
      data: {
        ...
        videoData: {
          create: videoDataFromCodes({
            handedness: 'TWO_S',
            dominantConfiguration: 'CONF_31',
            configurationChanges: 'OPENING_AND_RUBBING',
            dominantRelationBetweenArticulators: 'ABOVE_BELOW',
            location: 'NEUTRAL_SPACE',
            movementRelatedOrientation: 'FRONT',
            orientationRelatedToLocation: 'AO_FINGERS_CONTRA',
            orientationChange: 'SUPINATION',
            contactType: 'INITIAL',
            movementType: 'ZIGZAG',
            movementDirection: 'BACKWARDS',
            vocalization: 'none',
    ...
    prisma.signVideo.create({
      data: {
        ...
        videoData: {
          create: videoDataFromCodes({
            handedness: 'ONE',
            dominantConfiguration: 'CONF_12',
            configurationChanges: 'UNBENDING',
            dominantRelationBetweenArticulators: 'FRONT',
            location: 'WEAK_HAND_PALM',
            movementRelatedOrientation: 'FRONT',
            orientationRelatedToLocation: 'AO_FINGERS_CONTRA',
            orientationChange: 'RADIAL_AND_ULNAR_FLEXION',
            contactType: 'CONTINUOUS',
            movementType: 'CROSS',
            movementDirection: 'BACKWARDS',
            vocalization: 'none',
    ...
    prisma.signVideo.create({
      data: {
        ...
        videoData: {
          create: videoDataFromCodes({
            handedness: 'TWO_S',
            dominantConfiguration: 'CONF_18',
            configurationChanges: 'CURVING',
            dominantRelationBetweenArticulators: 'NEXT_TO',
            location: 'HORIZONTAL_PLANE',
            movementRelatedOrientation: 'FRONT',
            orientationRelatedToLocation: 'AO_FINGERS_CONTRA',
            orientationChange: 'ROTATION',
            contactType: 'CONTINUOUS',
            movementType: 'STRAIGHT_TO_CIRCLE',
            movementDirection: 'BACKWARDS',
            vocalization: 'none',
            nonManualComponent: 'none',
            inicialization: 'none',
    ...
    prisma.signVideo.create({
      data: {
        ...
        videoData: {
          create: videoDataFromCodes({
            handedness: 'ONE',
            dominantConfiguration: 'CONF_25',
            configurationChanges: 'OPENING_AND_WIGGLING',
            dominantRelationBetweenArticulators: 'BELOW',
            location: 'WEAK_HAND_PALM',
            movementRelatedOrientation: 'FRONT',
            orientationRelatedToLocation: 'AO_FINGERS_CONTRA',
            orientationChange: 'ULNAR_FLEXION',
            contactType: 'NONE_TO_INITIAL',
            movementType: 'ARC',
            movementDirection: 'BACKWARDS',
            vocalization: 'none',
            nonManualComponent: 'none',
    ...
    prisma.signVideo.create({
      data: {
        ...
        videoData: {
          create: videoDataFromCodes({
            handedness: 'ONE',
            dominantConfiguration: 'CONF_35',
            configurationChanges: 'OPENING_TO_CLOSING',
            dominantRelationBetweenArticulators: 'ABOVE',
            location: 'WEAK_HAND_PALM',
            movementRelatedOrientation: 'FRONT',
            orientationRelatedToLocation: 'AO_FINGERS_CONTRA',
            orientationChange: 'PRONATION_TO_FLEXION',
            contactType: 'FINAL_TO_CONTINUOUS',
            movementType: 'STRAIGHT',
            movementDirection: 'BACKWARDS',
            vocalization: 'none',
            nonManualComponent: 'none',
    ...
    prisma.signVideo.create({
      data: {
        ...
        videoData: {
          create: videoDataFromCodes({
            handedness: 'TWO_S',
            dominantConfiguration: 'CONF_42',
            configurationChanges: 'CLOSING_TO_OPENING',
            dominantRelationBetweenArticulators: 'FRONT_BACK',
            location: 'NEUTRAL_SPACE',
            movementRelatedOrientation: 'FRONT',
            orientationRelatedToLocation: 'AO_FINGERS_CONTRA',
            orientationChange: 'SUPINATION_TO_PRONATION',
            contactType: 'CONTINUOUS_TO_NONE',
            movementType: 'MOTIVATED_SHAPE',
            movementDirection: 'BACKWARDS',
            vocalization: 'none',
            nonManualComponent: 'none',
