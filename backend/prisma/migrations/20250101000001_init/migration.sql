...
-- CreateEnum
CREATE TYPE "RelationType" AS ENUM ('SYNONYM', 'REGIONAL_VARIANT', 'ASSOCIATED_CONCEPT', 'ANTONYM', 'HOMONYM', 'VARIANT', 'HYPERNYM', 'HYPONYM');
...
CREATE TABLE "VideoData" (
    ...
    "movementDirection" "MovementDirection" NOT NULL,
    "vocalization" TEXT NOT NULL,
    "nonManualComponent" TEXT NOT NULL,
    "inicialization" TEXT NOT NULL,
    "repeatedMovement" BOOLEAN NOT NULL DEFAULT false,
    "id" TEXT NOT NULL,
